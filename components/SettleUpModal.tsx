...
export default function SettleUpModal({
  visible, onClose, onSettled, groupId, memberId, memberName, balance, avatarIndex, currency,
}: Props) {
  ...
  // Reset transient state whenever the modal is (re)opened for a new member.
  useEffect(() => {
    if (visible) {
